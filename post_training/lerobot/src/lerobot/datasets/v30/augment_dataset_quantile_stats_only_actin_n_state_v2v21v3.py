...
def process_single_episode(dataset: LeRobotDataset, episode_idx: int) -> dict:
    ...
    for idx in range(start_idx, end_idx):
        ...
        for key, value in item.items():
            # !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            if key not in [ACTION_KEY, STATE_KEY]:
                continue
            # !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!1
...
def augment_dataset_with_quantile_stats(
    ...
    # dataset.meta.stats = new_stats # This replaces the entire stats object

    for key in [ACTION_KEY, STATE_KEY]:
        dataset.meta.stats[key] = new_stats[key]
